...
public class UsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView crearTiendaTexto = findViewById(R.id.crearTiendaTexto);

        Spinner crearArea = findViewById(R.id.crearArea);
        Spinner crearTienda = findViewById(R.id.crearTienda);
        ...
        crearTienda.setAdapter(arrayAdapter2);
        ...
        crearTienda.setFocusable(true);
        crearTienda.setFocusableInTouchMode(true);
        crearTienda.setOnFocusChangeListener((view, hasFocus) -> {
            if (hasFocus) {
                crearTienda.performClick();
                crearTiendaTexto.setTextColor(Color.parseColor("#003C8F"));
            }else { crearTiendaTexto.setTextColor(Color.parseColor("#CFCFCF")); }
        });
        ...
        crearButton.setOnClickListener(v -> {
            ...
            String selectTienda = crearTienda.getSelectedItem().toString();
