                        ...
                        asyncHttpClient.post(insertUrl, new AsyncHttpResponseHandler() {
                            ...
                            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                if (statusCode == 200) {
                                    ...
                                    String insertUrl = ("https://www.sionm.tech/Aplicacion_DispositivoMovil/notification.php?Title=CALIDAD"
                                            + "&Message="+firebaseAuth.getDisplayName()+" envía el número de lote "
                                            + ccLote.getText() +"&NombreCompleto="+ccNombre.getText()).replaceAll(" ","%20");
